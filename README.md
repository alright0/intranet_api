...
Это приложение является внутренним сайтом,на котором находится два основных раздела: Сайт с дэшбордами и API, позволяющее другим приложениям иметь доступ к базе. К сожалению, я не могу предоставить полную информацию, поэтому на некоторых скриншотах заблюрена или стерта некоторая информация.
Пример с измененными данными: http://laright0-git-app.herokuapp.com/
